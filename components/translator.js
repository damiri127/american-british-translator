...
class Translator {
    ...
    translate(text, dict, titles, timeRegex, locale) {
        ...
        // mencari titike dan memasukkannya kedalam object map
        ...
        // menyaring kata dengan spasi dari kamus saat ini
        ...
        // return logic
        console.log("macthesMap :>> ", matchesMap);
    ...
    replaceAll(text, macthesMap) {
        const re = new RegExp(Object.keys(macthesMap).join("|"), "gi");
        return text.replace(re, (macthed) => macthesMap[macthed.toLowerCase()]);
    }

    replaceAllWithHighlight(text, macthesMap) {
        const re = new RegExp(Object.keys(macthesMap).join("|"), "gi");
        return text.replace(re, (macthed) => {
        return `<span class="highlight">${
            macthesMap[macthed.toLowerCase()]
        }</span>`;
        });
    }
    }
